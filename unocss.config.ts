...
export default defineConfig({
  ...
  shortcuts: [{
    ...
    'gpt-subtitle': 'text-(2xl transparent) font-extrabold bg-(clip-text gradient-to-r) from-indigo-500 via-purple-500 to-pink-500',
    ...
    'gen-slate-btn': 'h-12 px-4 py-2 bg-(slate op-15) hover:bg-op-20 rounded-full',
    ...
    'gen-textarea': 'w-full px-3 py-3 min-h-12 max-h-3 rounded-full bg-(slate op-15) resize-none base-focus placeholder:op-50 dark:(placeholder:op-30) scroll-pa-8px pl-10',
